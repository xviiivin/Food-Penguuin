    ...
    return (
        <ScrollView className="p-10 bg-white " style={styles.container}>
            <View className="flex items-center justify-center mt-16">
                <Image source={require('../assets/Logo.png')} className='w-3/4 h-[40px] ' /></View>
            ...
            <TextInput
                className='border border-[#A1A1A1] mt-4 rounded-lg w-full h-12 items-center justify-center p-4' placeholder='ยืนยันรหัสผ่าน'
            />
            <TextInput
                className='border border-[#A1A1A1] mt-4 rounded-lg w-full h-12 items-center justify-center p-4' placeholder='ยืนยันรหัสผ่าน'
            />
