    ...
    <ScrollView className="bg-white">
      <View className="p-10  h-full gap-y-10">
        ...
        <View>
          ...
          <Text className="font-notob text-lg mt-2">
            {data1 && data1.email}
          </Text>
          <Text className="font-notob text-xl  color-[#FA1717] mt-12">
            !! โปรดอ่าน !!
          </Text>
          <Text className="font-notob text-md mt-2">
            หลังจากทำการกดยืนยันตันทางเจ้าของร้านอาหาร
          </Text>
          <Text className="font-notob text-md">
            ต้องมายื่นเอกสารรายละเอียดทั้งหมด
          </Text>
          <Text className="font-notob text-md"> ณ ห้องอาคารและสถานที่ </Text>
          <Text className="font-notob text-md">
            {" "}
            คณะเทคโนโลยีสารสนเทศ (ไอทีลาดกระบัง)
          </Text>
        </View>
