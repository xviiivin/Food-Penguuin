    ...
    <ScrollView className="p-10 bg-white">
      <View className="flex gap-6">
          ...
          <View>
            <View className="flex flex-row justify-between items-center">
              <View>
                ...
                <Text className="font-notom">{formatTimestamp(item.created_at.seconds)}</Text>
              </View>
              <View>
                <Text className="font-notoe bg-[#F6D544] p-2 rounded-xl">
                  ระยะเวลา ~ {item.menu.reduce((accumulator, currentValue) => {
            ...
            <View className="flex flex-row justify-between items-center">
              ...
              <Text className="font-notom  text-[18px]">{item.queue} คิว</Text>
            </View>
            <View>
              <View>
        ...
        <View className="flex flex-row justify-between">
          ...
          <Text className="font-notom text-[18px]">{data.reduce((accumulator, currentValue) => {
